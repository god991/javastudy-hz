       ...
       -->
		<c:forEach items="${requestScope.proList}" var="product">
			<tr>
				...
				<td>${product.date}</td>
				<!-- 所有的a标签都是get请求 -->
				<td><a href="${pageContext.request.contextPath}/product/update?id=${product.id}&type=delete">更新</a>|
				<a href="${pageContext.request.contextPath}/product/delete?id=${product.id}&type=delete">删除</a></td>
			</tr>
		</c:forEach>
	</table>
